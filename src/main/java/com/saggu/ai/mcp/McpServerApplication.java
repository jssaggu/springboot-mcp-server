/**
 * Entry point for the MCP Server Spring Boot application.
 *
 * This class bootstraps the application and defines a ToolCallbackProvider bean
 * using Spring AI's MethodToolCallbackProvider to expose WeatherService methods
 * as callable tools, potentially for integration with AI agents or chat interfaces.
 */
package com.saggu.ai.mcp;

import com.saggu.ai.mcp.service.OrderMcpServerService;
...
public class McpServerApplication {
	...
	@Bean
	public ToolCallbackProvider orderTools() {
		return MethodToolCallbackProvider.builder().toolObjects(new OrderMcpServerService()).build();
	}
